...
export function ContactForm({
  ...
  const submitting =
    isSubmitting !== undefined ? isSubmitting : defaultFormValues.isSubmitting;
  ...
  return (
    <Form {...formProps}>
      ...
      >
        <h3 className="text-2xl font-semibold mb-4 text-braden-navy font-montserrat">
          Contact Us
        </h3>
        <p className="text-braden-slate mb-6">
          Get in touch with our team to learn more about how we can help with
