...
const Hero = () => {
  ...
  return <section id="home" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden" role="banner" aria-label="Welcome to Braden Group">
      ...
      <div className="relative z-20 text-center text-white max-w-4xl mx-auto px-4 py-12 md:py-20" role="contentinfo">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center" role="group" aria-label="Call to action buttons">
          <button onClick={handleStartHiring} className="bg-brand-primary text-white font-montserrat font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-opacity-90 transition-all text-sm sm:text-base focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary focus:outline-none" aria-label="Start hiring apprentices and trainees">
            Start Hiring
          </button>
          <button onClick={handleFindOpportunities} className="bg-white text-brand-primary font-montserrat font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-opacity-90 transition-all text-sm sm:text-base focus:ring-2 focus:ring-offset-2 focus:ring-white focus:outline-none" aria-label="Find apprenticeship and traineeship opportunities">
            Find Opportunities
          </button>
        </div>
      </div>
