...
interface TypographyPanelProps {
  ...
  onTypographyChange: (
    field: keyof ThemeSettings['typography'],
    value: string
  ) => void;
}
  ...
  return (
    <Card>
      <CardContent className="pt-6 space-y-6">
        <div>
          <Label htmlFor="headingFont" className="text-sm font-medium">
            Heading Font
          </Label>
          <Input
            id="headingFont"
        ...
        <div>
          <Label htmlFor="bodyFont" className="text-sm font-medium">
            Body Font
          </Label>
          <Input
            id="bodyFont"
        ...
        <div>
          <Label htmlFor="baseFontSize" className="text-sm font-medium">
            Base Font Size
          </Label>
          <Input
            id="baseFontSize"
