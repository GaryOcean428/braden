...
interface SpacingPanelProps {
  ...
  onSpacingChange: (
    field: keyof ThemeSettings['spacing'],
    value: string
  ) => void;
}
  ...
  return (
    <Card>
      <CardContent className="pt-6 space-y-6">
        <div>
          <Label htmlFor="baseSpacingUnit" className="text-sm font-medium">
            Base Spacing Unit
          </Label>
          <Input
            id="baseSpacingUnit"
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Base unit for spacing (e.g., 4px)
          </p>
        </div>

        <div>
          <Label htmlFor="spacingScale" className="text-sm font-medium">
            Spacing Scale
          </Label>
          <Input
            id="spacingScale"
          ...
          />
          <p className="text-xs text-muted-foreground mt-1">
            Scale factor for spacing (e.g., 1.5)
          </p>
        </div>
      </CardContent>
    </Card>
