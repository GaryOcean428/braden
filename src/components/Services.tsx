...
import { BriefcaseIcon, BookOpenIcon, ShieldCheckIcon, UsersIcon, ComputerDesktopIcon, RocketLaunchIcon } from "@heroicons/react/24/outline";
  ...
  const services = [
    {
      ...
      icon: <BookOpenIcon className="h-8 w-8 text-[#ab233a]" />
    },
    {
      ...
      path: "/compliance",
      icon: <ShieldCheckIcon className="h-8 w-8 text-[#ab233a]" />
    },
    {
      ...
      path: "/mentoring",
      icon: <UsersIcon className="h-8 w-8 text-[#ab233a]" />
    },
    {
    ...
    },
    {
      ...
      icon: <RocketLaunchIcon className="h-8 w-8 text-[#ab233a]" />
    }
  ];
    ...
    <ErrorBoundary>
      <section id="services" className="py-16 md:py-20 lg:py-24 px-4 md:px-8 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-montserrat font-bold text-3xl md:text-4xl lg:text-5xl mb-12 text-center text-[#2c3e50]">
            Our Services
          </h2>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="flex items-center mb-4">
                  {service.icon}
                  <h3 className="font-montserrat font-bold text-lg md:text-xl ml-3 group-hover:text-[#ab233a] transition-colors">{service.title}</h3>
                </div>
