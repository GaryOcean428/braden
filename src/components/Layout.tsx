            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="md:col-span-2">
                ...
                <p className="mb-4 text-gray-300">
                  Professional recruiting solutions for apprenticeships and
                  traineeships.
                </p>
                <p className="text-[#cbb26a] font-semibold font-heading">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <a
                      href="/login"
                      className="text-[#cbb26a] hover:text-[#d8c690] transition-colors font-medium"
                    >
                      Client Login
                    </a>
                  </li>
