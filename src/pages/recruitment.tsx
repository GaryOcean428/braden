      ...
      <section className="pt-24 pb-16 px-4">
        <div className="container mx-auto text-center text-white">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            Connecting talented professionals with leading businesses across
            Australia
          </p>
          <Button
            variant="secondary"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Find the perfect long-term fit for your organization with our
                comprehensive permanent recruitment solutions.
              </p>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Flexible staffing solutions for project-based needs and
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Thorough screening and shortlisting of qualified candidates
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Coordinating interviews and facilitating communication
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Ensuring successful onboarding and continued support
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-brand-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Whether you're looking to hire or seeking new opportunities, we're
            here to help.
          </p>
          <Button variant="secondary" size="lg" onClick={navigateToContact}>
            Contact Us Today
          </Button>
        </div>
      </section>
