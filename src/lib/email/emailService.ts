...
export const sendLeadConfirmationEmail = async (email: string, name: string, serviceType: string) => {
  try {
    console.log(`Sending lead confirmation email to ${email} (${name}) for service: ${serviceType}`);
